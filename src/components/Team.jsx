...
const Team = () => {
  return (
    <div className=' w-11/12  px-4 mx-auto grid grid-cols-4 gap-6'>
        {employees.map((item,id)=>(<div key={id} className='h-[16vh] rounded-2xl shadow-lg shadow-gray-300  items-center gap-6 p-6 flex '>
