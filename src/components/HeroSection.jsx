...
const HeroSection = () => {
    return (
        <div id='home' className='w-11/12 mx-auto relative    flex flex-col gap-4  items-center text-black '>
            ...
            <div className='text-7xl w-full  flex flex-col gap-2  items-center    font-bold hero-text relative z-10'>
                <p>Turning imagination into</p>
                <p > <span className='text-purple-700 pr-4'>digital</span>impact.</p>  
            </div>

            <p className='w-[38%] mt-2 text-center text-xl relative z-10'>Creating meaningful connections and turning big ideas into interactive digital experiences</p>

            <img src={bggradient1} className='absolute -translate-y-20 left-[20vw] z-1 pointer-events-none' alt="" />
            <img src={heroimg} alt="" className='z-2 w-[80%] mt-14' />
            <img src={bggradient2} className='absolute -translate-x-130 top-60 z-1 pointer-events-none' alt="" />
